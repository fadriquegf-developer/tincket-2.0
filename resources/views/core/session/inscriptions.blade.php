...
@section('header')
    ...
    @endphp
    <section class="content-header ms-3 mb-6">
...
<div class="container-fluid px-0">
    <div class="card shadow-xs border-xs">
        <div class="card-header border-xs mb-2">
            <h3 class="mb-0 flex-grow-1">{{ __('backend.inscription.list_title') }}</h3>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="inscription-table" class="table table-striped table-hover mb-0 align-middle">
...
@push('after_styles')
    ...
    <style>
        ...
        .dataTables_filter input { border-radius: .25rem; margin-right: 1.25rem }
        .dataTables_length { margin-left: 1.5rem; }
        .dataTables_info {
            margin-left: 1rem;
        }
        ...
        #inscription-table tbody td:first-child { padding-left: .75rem; }
        #inscription-table thead th:first-child { padding-left: .75rem; }
        #inscription-table tbody td { padding-top: 1.25rem; padding-bottom: 1.25rem; }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const dt = $('#inscription-table').DataTable({
                ...
                ordering: true,
                dom:
                    "<'row mb-2'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6 text-end'fB>>" +
                    "rt" +
