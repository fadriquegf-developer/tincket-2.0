<td style="vertical-align: top;">
    <a href="{{ replace_route_parameters(config('clients.frontend.routes.' . config('app.locale') . '.browse.event.show'), [
    $entity->slug,
    $entity->id
        ...
        <span style="margin-bottom: 25px;">
             {{ \Illuminate\Support\Str::limit(strip_tags(html_entity_decode($entity->description)), 200) }}
        </span>
    </a>
</td>