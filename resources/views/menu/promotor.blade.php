...
<!-- CRM -->
@canany(['events.index', 'sessions.index', 'locations.index', 'zones.index', 'spaces.index', 'rates.index', 'forms.index', 'form_fields.index'])
    <x-backpack::menu-dropdown title="CRM" icon="la la-address-book">
        ...
        @can('sessions.index')
            <x-backpack::menu-dropdown-item title="Sessions" icon="la la-clock" :link="backpack_url('session')" />
        @endcan
...
<!-- Taquilla -->
@canany(['clients.index', 'carts.index',])
...
<x-backpack::menu-dropdown title="{{ __('backend.menu.statistics') }}" icon="la la-chart-bar">
    <x-backpack::menu-dropdown-item title="Elemento 5" :link="backpack_url('ruta5')" />
</x-backpack::menu-dropdown>