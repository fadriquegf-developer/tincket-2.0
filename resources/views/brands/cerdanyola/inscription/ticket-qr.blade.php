            ...
            <div class="col-3">
                @if ($inscription->session->event->custom_logo)
                    <img style="max-width: 100%;"
                        src="/storage/uploads/{{ $inscription->session->event->custom_logo }}" />
                @endif
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-9" style="padding-right: 10px;">
                <div
                    ...
                    @else
                        <b>ENTRADA INDIVIDUAL - {{ sprintf("%s - %s €", $inscription->getRateName(), number_format($inscription->price_sold, 2)) }}</b>
                    @endif
                </div>
                <div
                    style="border-top: 2px solid black; padding: 10px 0px; text-transform: uppercase; font-size: 18px;">
