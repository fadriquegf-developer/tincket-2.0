        ...
        <div class="row">
            <div class="col-10">
                <div class="pr">
                  ...
                  <div class="row">
                          <div class="col-12">
                              <h4 class="font-heavy title-overflow p-0 m-0">{{ $inscription->session->name }}</h4>
                              <h6 class="p-0 m-0">{{ $inscription->slot->name ?? '' }}</h6>
                              <div class="spacer"></div>
                                  @php
                              ...
                              <div class="spacer "></div>
                                  ...
                                  @endif
                              <div class="spacer"></div>
                                  <span class="text-muted">{{ sprintf("Nº %s", $inscription->cart->confirmation_code) }}</span>
                              <div class="spacer"></div>
                          </div>
                  </div>              
                </div>
            ...
            <div class="col-2 right" style="background-color:white;">
                <div class="spacer"></div>
                ...
                <div class="spacer"></div>
                <small>{{ $inscription->barcode }}</small>
            </div>
        </div>
    </div>
