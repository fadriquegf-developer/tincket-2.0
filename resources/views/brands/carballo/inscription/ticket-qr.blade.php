...
<body>
    ...
    <div class="row">
      <div class="col-9">
        <div class="pr">
          ...
          <div class="row">
            <div class="col-12">
              <h4 class="font-heavy title-overflow p-0 m-0">{{ $inscription->session->event->getTranslation('name', 'gl') }}</h4>
              @if($inscription->session->event->getTranslation('lead', 'gl'))
              <p class="text-small title-overflow p-0 m-0">
              {{ $inscription->session->event->getTranslation('lead', 'gl') }}
              </p>
              @endif
              <p class="text-small title-overflow p-0 m-0">
  ...
  <div class="col-10 text-extra-small" style="position: absolute; bottom: 10px; left: 0px;">
    Non se permitirá a entrada unha vez comezado o evento. A organización resérvase o dereito de modificar o programa do evento.
  </div>
