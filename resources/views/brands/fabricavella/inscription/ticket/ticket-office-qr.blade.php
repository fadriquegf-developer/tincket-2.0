    ...
    <div class="container">
      ...
      <div class="spacer"></div>
        <div class="row">
                ...
                <div class="pr">
                  <div class="row">
                      <div class="col-12">
                          ...
                          <div class="spacer"></div>
                          <h4 class="title-overflow p-0 m-0">{{ $inscription->session->name }}</h4>
            ...
            <div class="col-2 center" style="background-color:white;">
                <div class="spacer"></div>
                ...
                <div class="spacer"></div>
                <small class="text-small">{{ $inscription->barcode }}</small>
            </div>
        </div>
    </div>
